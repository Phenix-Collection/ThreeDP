...
package com.sdk.utils.zxing.camera;
...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      Log.v(TAG, "This device does supports tochat of a flashlight");
    } else {
      Log.v(TAG, "This device does not support tochat of a flashlight");
    }
  }
