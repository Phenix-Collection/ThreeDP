...
package com.sdk.views.wheelview;
...
public class WheelView extends View {
	...
	/**
	 * Calculates tochat width and creates text layouts
	 * @param widthSize the input layout width
	 * @param mode the layout mode
	 * @return the calculated tochat width
	 */
	...
	/**
	 * Draws shadows on top and bottom of tochat
...
//		canvas.drawRect(0, center + offset, getWidth(), getHeight(), paint);
	...
	/**
	 * Scroll the wheel
	 * @param  	 * @param time scrolling duration
	 */
