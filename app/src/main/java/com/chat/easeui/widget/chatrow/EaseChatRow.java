package com.chat.easeui.widget.chatrow;
...
public abstract class EaseChatRow extends LinearLayout {
     ...
     * @param position
     */
    public void setUpView(FriendInfoEntity userInfo, EMMessage message, int position, EaseChatMessageList.MessageListItemClickListener itemClickListener, EaseChatRowActionCallback itemActionCallback, EaseMessageListItemStyle itemStyle) {
        this.message = message;
        this.position = position;
        ...
        setUpBaseView(userInfo);
        onSetUpView();
        setClickListener();
    }

    private void setUpBaseView(FriendInfoEntity userInfo) {
        ...
        if(userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                EaseUserUtils.setUserAvatar(context, CacheDataService.getLoginInfo().getUserInfo(), userAvatarView);
            } else {
                EaseUserUtils.setUserAvatar(context, userInfo, userAvatarView);
