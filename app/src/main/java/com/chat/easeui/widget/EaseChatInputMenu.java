...
import com.chat.easeui.domain.EaseEmojiconGroupEntity;
import com.chat.easeui.model.EaseDefaultEmojiconDatas;
import com.chat.easeui.utils.EaseSmileUtils;
import com.chat.easeui.widget.emojicon.EaseEmojiconMenu;
import com.chat.easeui.widget.emojicon.EaseEmojiconMenuBase;
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if(emojiconMenu == null){
            ...
            if(emojiconGroupList == null){
                ...
                emojiconGroupList.add(new EaseEmojiconGroupEntity(R.drawable.emoji_1,  Arrays.asList(EaseDefaultEmojiconDatas.getData())));
            }
