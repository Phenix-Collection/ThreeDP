...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentArgs = this.getIntent().getExtras();
...
//        this.turnOnTyping = turnOnTyping();
    ...
    protected void initView() {
        ...
        //noinspection ConstantConditions
        voiceRecorderView = (EaseVoiceRecorderView) this.findViewById(R.id.voice_recorder);
...
//        messageList.setAvatarShape(1);
        ...
        kickedForOfflineLayout = this.findViewById(R.id.layout_alert_kicked_off);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.icon_065);
        } else {
            titleBar.setRightImageResource(R.drawable.icon_092);
        ...
        String forward_msg_id = this.getIntent().getExtras().getString("forward_msg_id");
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public boolean onResendClick(final EMMessage message) {
                ...
                new EaseAlertDialog(EaseChatFragment.this, R.string.resend, R.string.confirm_resend, null, new EaseAlertDialog.AlertDialogUser() {
                    @Override
            ...
            fetchQueue.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Activity activity = EaseChatFragment.this;
                        if (activity != null) {
    ...
    protected void onChatRoomViewCreation() {
        ...
        EMClient.getInstance().chatroomManager().joinChatRoom(toChatUsername, new EMValueCallBack<EMChatRoom>() {
            ...
            public void onSuccess(final EMChatRoom value) {
                EaseChatFragment.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        if (EaseChatFragment.this.isFinishing() || !toChatUsername.equals(value.getId()))
                            return;
                        pd.dismiss();
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_PICTURE:
                    ...
                    break;
                case ITEM_LOCATION:
                    startActivityForResult(new Intent(EaseChatFragment.this, EaseBaiduMapActivity.class), REQUEST_CODE_MAP);
                    break;
    ...
    class GroupListener extends EaseGroupListener {
            ...
            EaseChatFragment.this.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if (toChatUsername.equals(groupId)) {
                        Toast.makeText(EaseChatFragment.this, R.string.you_are_group, Toast.LENGTH_LONG).show();
                        Activity activity = EaseChatFragment.this;
        ...
        public void onGroupDestroyed(final String groupId, String groupName) {
            ...
            EaseChatFragment.this.runOnUiThread(new Runnable() {
                public void run() {
                    if (toChatUsername.equals(groupId)) {
                        Toast.makeText(EaseChatFragment.this, R.string.the_current_group_destroyed, Toast.LENGTH_LONG).show();
                        Activity activity = EaseChatFragment.this;
                        if (activity != null && !activity.isFinishing()) {
                            activity.finish();
                        }
    ...
    class ChatRoomListener extends EaseChatRoomListener {
            ...
            EaseChatFragment.this.runOnUiThread(new Runnable() {
                public void run() {
                    if (roomId.equals(toChatUsername)) {
                        Toast.makeText(EaseChatFragment.this, R.string.the_current_chat_room_destroyed, Toast.LENGTH_LONG).show();
                        Activity activity = EaseChatFragment.this;
                        if (activity != null && !activity.isFinishing()) {
                            activity.finish();
                        }
                ...
                public void run() {
                    if (roomId.equals(toChatUsername)) {
                        if (reason == EMAChatRoomManagerListener.BE_KICKED) {
                            Toast.makeText(EaseChatFragment.this, R.string.quiting_the_chat_room, Toast.LENGTH_LONG).show();
                            Activity activity = EaseChatFragment.this;
                            if (activity != null && !activity.isFinishing()) {
                                activity.finish();
                            }
                            ...
                            Toast.makeText(EaseChatFragment.this, "User be kicked for offline", Toast.LENGTH_SHORT).show();
        ...
        public void onMemberJoined(final String roomId, final String participant) {
            if (roomId.equals(toChatUsername)) {
                EaseChatFragment.this.runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(EaseChatFragment.this, "member join:" + participant, Toast.LENGTH_LONG).show();
                    }
                });
            }
        }
        ...
        public void onMemberExited(final String roomId, final String roomName, final String participant) {
            if (roomId.equals(toChatUsername)) {
                EaseChatFragment.this.runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(EaseChatFragment.this, "member exit:" + participant, Toast.LENGTH_LONG).show();
                    }
                });
            }
        }
