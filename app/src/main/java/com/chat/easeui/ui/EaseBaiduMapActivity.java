...
public class EaseBaiduMapActivity extends BaseActivity {
	...
	public class BaiduSDKReceiver extends BroadcastReceiver {
		public void onReceive(Context context, Intent intent) {
			...
			if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_ERROR)) {
				...
				Toast.show(instance, st2, Toast.LENGTH_SHORT);
			} else if (s.equals(SDKInitializer.SDK_BROADCAST_ACTION_STRING_NETWORK_ERROR)) {
				Toast.show(instance, st1, Toast.LENGTH_SHORT);
			}
		}
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(!PermissionsUtil.hasAccessCoarseLocationPermission(this)){
			Toast.show(this, "没有访问位置权限，请到设置中设置.", Toast.LENGTH_LONG);
			return;
		}
