...
import com.chat.easeui.widget.EaseContactList;
...
//        super.onActivityCreated(savedInstanceState);
    ...
    protected void initView() {
        contentContainer = (FrameLayout) this.findViewById(R.id.content_container);
        
        contactListLayout = (EaseContactList) this.findViewById(R.id.contact_list);
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    EaseContactListFragment.this.runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            Toast.makeText(EaseContactListFragment.this, st2, Toast.LENGTH_SHORT).show();
                            refresh();
                        }
                    });
                    ...
                    EaseContactListFragment.this.runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            Toast.makeText(EaseContactListFragment.this, st3, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
