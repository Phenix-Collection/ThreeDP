...
import com.chat.easeui.model.EaseImageCache;
import com.chat.easeui.utils.EaseLoadLocalBigImgTask;
import com.chat.easeui.widget.photoview.EasePhotoView;
...
public class EaseShowBigImageActivity extends EaseBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.login_head);
