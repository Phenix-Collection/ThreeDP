 ...
 */
package com.chat.easeui.adapter;
...
import com.chat.easeui.widget.presenter.EaseChatBigExpressionPresenter;
import com.chat.easeui.widget.presenter.EaseChatFilePresenter;
import com.chat.easeui.widget.presenter.EaseChatImagePresenter;
import com.chat.easeui.widget.presenter.EaseChatLocationPresenter;
import com.chat.easeui.widget.presenter.EaseChatRowPresenter;
import com.chat.easeui.widget.presenter.EaseChatTextPresenter;
import com.chat.easeui.widget.presenter.EaseChatVideoPresenter;
import com.chat.easeui.widget.presenter.EaseChatVoicePresenter;
...
//    private String toChatUsername;
	private FriendInfoEntity userInfo;
	...
	public EaseMessageAdapter(Context context, FriendInfoEntity data, int chatType, ListView listView) {
		this.context = context;
		this.listView = listView;
//		toChatUsername = username;
		this.userInfo = data;
		this.conversation = EMClient.getInstance().chatManager().getConversation(data.getAccount(), EaseCommonUtils.getConversationType(chatType), true);
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		presenter.setup(userInfo, message, position, itemClickListener, itemStyle);
