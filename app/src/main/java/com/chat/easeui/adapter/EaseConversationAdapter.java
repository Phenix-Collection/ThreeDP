...
import com.chat.easeui.widget.EaseImageView;
...
import com.sdk.utils.imgeloader.utils.ImageLoader;
...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    //        holder.list_itease_layout = (PullRelativeLayout) convertView.findViewById(R.id.list_itease_layout);
   ...
   //     holder.list_itease_layout.setBackgroundResource(R.drawable.ease_mm_listitem);
        ...
        FriendInfoEntity friend = CacheDataService.getFriendInfo(conversation.conversationId());
...
//            EaseUserUtils.setUserAvatar(getContext(), username, holder.avatar);
            if(friend != null){
                CacheImageControl.getInstance().setImageView( holder.avatar,Globals.BASE_API + friend.getProfile_photo(), true);
                EaseUserUtils.setUserNick(friend.getRemark().length() == 0 ? friend.getNick_name() : friend.getRemark(), holder.name);
            }
            holder.motioned.setVisibility(View.GONE);
        }
...
//                            username = user.getNick();
    ...
    private static class ViewHolder {
        ...
        View msgState;
        /** layout */
   //     PullRelativeLayout list_itease_layout;
        TextView motioned;
    }
}
