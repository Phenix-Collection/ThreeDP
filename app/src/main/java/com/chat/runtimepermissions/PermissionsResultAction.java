...
public abstract class PermissionsResultAction {
   ...
   * so that it will know which permissions to icon_look for changes to. The PermissionsResultAction
   * will then know to icon_look out for changes to these permissions.
   *
